...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        image: {
            image: 'image',
            insert: '이미지 삽입',
            resizeFull: '이미지 크기 100%',
            resizeHalf: '이미지 크기 50%',
            resizeQuarter: '이미지 크기 25%',
            floatLeft: '왼쪽으로 이동',
            floatRight: '오른쪽으로 이동',
            floatNone: '이동 없음',
            shapeRounded: '모양: 둥글게',
            shapeCircle: '모양: 원형',
            shapeThumbnail: '모양: 미리보기',
            shapeNone: '모양: 없음',
            dragImageHere: '이미지를 여기에 드래그 해주세요',
            dropImage: '이미지를 여기에 드롭해주세요',
            selectFromFiles: '파일을 선택하세요',
            maximumFileSize: '최대 파일 크기',
            maximumFileSizeError: '최대 파일 크기 초과',
            url: '이미지 URL',
            remove: '이미지 제거',
            original: 'Original'
        },
        ...
        link: {
            ...
            url: '이 링크는 어떤 URL에 연결할까요?',
            openInNewWindow: '새 창 띄움'
        },
        table: {
            table: '표',
            addRowAbove: '위에 행 추가',
        ...
        color: {
            ...
            foreground: '전경색',
            transparent: '투명',
            setTransparent: '투명하게 설정',
            reset: '기본 설정',
            resetToDefault: '기본 설정'
        },
        shortcut: {
            shortcuts: '키보드 단축키',
            close: '닫기',
            textFormatting: '텍스트 서식 지정',
            action: '동작',
            paragraphFormatting: '단락 서식',
        ...
        help: {
            ...
            'italic': '기울임 스타일',
            'underline': '밑줄 스타일',
            'strikethrough': '취소선 스타일',
            'removeFormat': '스타일 제거',
            'justifyLeft': '왼쪽 정렬',
            'justifyCenter': '가운데 정렬',
            'justifyRight': '오른쪽 정렬',
            'justifyFull': '양쪽 맞춤 정렬',
            'insertUnorderedList': '목록',
            'insertOrderedList': '숫자형 목록',
            'outdent': '내어쓰기',
            'indent': '들여쓰기',
            'formatPara': '기본 단락 스타일 변경',
            'formatH1': '첫번째 스타일 변경',
            'formatH2': '두번째 스타일 변경',
            'formatH3': '세번째 스타일 변경',
            'formatH4': '네번째 스타일 변경',
            'formatH5': '다섯번째 스타일 변경',
            'formatH6': '여섯번째 스타일 변경',
            'insertHorizontalRule': '가로 규칙 삽입',
            'linkDialog.show': '링크 표시'
        },
        history: {
            undo: 'Undo',
            redo: 'Redo'
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        fontNames: [
            'Arial', 'Arial Black', 'Comic Sans MS', 'Courier New', '돋움', '굴림',
            'Helvetica Neue', 'Helvetica', 'Impact', 'Lucida Grande', '맑은 고딕',
